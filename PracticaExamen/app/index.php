...
<body>
    ...
    if (isset($_POST["btnDetalle"])) {
        ...
        // Código para editar
        ?>
                <h2>Editando el usuario
            <?php print $_POST["btnEditar"] ?>
                </h2>
                ...
                <form action="index.php" method="post">
                    ...
                    <p>
                        <button type="submit" name="btnContEditar" value=<?php print $_POST["btnEditar"] ?>
                            id="boton-continuar">Continuar</button>
